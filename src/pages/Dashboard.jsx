...
export default function Dashboard() {
  ...
  // Cached list from paperListStore — instant render on revisits.
  ...
  // Loading skeleton only on the *very first* load (no cache yet).
      ...
      <motion.div variants={item}>
        ...
        <div className="flex flex-col gap-3 sm:gap-4">
          <div className="flex items-start justify-between gap-3">
            ...
            <RefreshButton onRefresh={handleRefresh} title="ড্যাশবোর্ড রিফ্রেশ" />
          </div>

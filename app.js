...
// Geometry AI translation — 1 credit per call, text-only (no image upload needed)
app.use('/api/geometry', requireAuth, isProd ? aiLimiter : noop, geometryRoutes)
// Vault — pre-built questions (no AI credits needed, read-only from DB)
app.use('/api/vault', vaultRoutes)
// Primary education (Nursery-Class 5) — assets, templates, bulk vault

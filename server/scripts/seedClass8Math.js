/**
 * Seed Class 8 Math Content from Markdown Files
 *
 * Reads all 11 chapter-XX.md files from server/data/books/class-8/math/
 * and loads them into:
 ...
 *
 * Usage: node server/scripts/seedClass8Math.js
 */
...
const CLASS_NUM = 8
const SUBJECT = 'math'
const BOOKS_DIR = path.resolve(__dirname, '../data/books/class-8/math')
...
// --- Main ---
async function main() {
  console.log(`\n📚 Class 8 Math — Seeding from markdown files`)

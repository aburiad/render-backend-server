 ...
 *
 * Reads all final-chapter-*.md files from this directory (class-six/)
 * and loads them into:
 ...
 *
 * Usage: node class-six/seedClass6Math.js
 */
...
const CLASS_NUM = 6
const SUBJECT = 'math'
const BOOKS_DIR = __dirname // reads from class-six/ itself

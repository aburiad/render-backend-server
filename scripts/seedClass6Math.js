/**
 * Seed Class 6 Math Content from Markdown Files
 *
 * Reads all final-chapter-*.md files from server/data/books/class-6/
 * and loads them into:
 ...
 *
 * Usage: node server/scripts/seedClass6Math.js
 */
...
const CLASS_NUM = 6
const SUBJECT = 'math'
const BOOKS_DIR = path.resolve(__dirname, '../data/books/class-6')
...
// --- Main ---
async function main() {
  console.log(`\n📚 Class 6 Math — Seeding from markdown files`)

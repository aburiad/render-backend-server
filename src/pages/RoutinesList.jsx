...
export default function RoutinesList() {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      {/* Teacher routine entry point */}
      {routines.length > 0 && (
        <button
          onClick={() => navigate('/routines/teachers')}
          className="btn-press flex items-center justify-between gap-3 px-4 py-3 rounded-xl border"
          style={{
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <div style={{ fontSize: 13, fontWeight: 800 }}>টিচার ভিত্তিক রুটিন দেখুন</div>
              <div style={{ fontSize: 11, opacity: 0.75 }}>প্রতি teacher-এর সাপ্তাহিক schedule</div>
            </div>
          </div>

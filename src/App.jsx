...
const PaperLevelSelector = lazy(() => import('@/components/paper/PaperLevelSelector'))
    ...
    <AnimatePresence mode="wait">
      ...
      <Routes location={location} key={location.pathname}>
        ...
        >
          ...
          <Route path="papers/new" element={<PaperLevelSelector />} />
          <Route path="papers/new/editor" element={<PaperEditor />} />
          <Route path="papers/new/primary" element={<PaperEditor />} />

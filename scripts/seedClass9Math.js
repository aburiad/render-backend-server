/**
 * Seed Class 9 Math Content from Markdown Files
 *
 * Reads all chapter-XX.md files from server/data/books/class-9/math/
 * and loads them into:
 ...
 *
 * Usage: node server/scripts/seedClass9Math.js
 */
...
const CLASS_NUM = 9
const SUBJECT = 'math'
const BOOKS_DIR = path.resolve(__dirname, '../data/books/class-9/math')
...
// --- Main ---
async function main() {
  console.log(`\n📚 Class 9 Math — Seeding from markdown files`)

...
async function _chatDirect({ messages, vision = false, jsonMode = false, temperature = 0.6, apiKey: providedKey, _forceFlash = false }) {
  let apiKeys = []
  if (providedKey) {
  ...
  // _forceFlash: skip Gemma models which ignore JSON instructions
  // and return bullet-point markdown. Used by geometry route.
